...
**_Disclaimer_**: _All datasets and reports do not represent any company, institution or country, but just a dummy mock data to demonstrate my Data Analytics skills with SQL and Power BI._
